...
const nextConfig = {
  ...
  allowedDevOrigins: [
    '172.16.31.17', // IP actual detectada automáticamente
    '192.168.*.*',
    '172.16.*.*',
    'localhost',
    '127.0.0.1'
  ...
  images: {
    ...
    unoptimized: false, // Habilitar optimización selectiva para mejor rendimiento
    ...
    remotePatterns: [
      ...
      {
        protocol: 'http',
        hostname: '172.16.31.17', // IP actual detectada automáticamente
        port: '3000',
        pathname: '/uploads/**',
      },
