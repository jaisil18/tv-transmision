        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              title={screen.active ? 'Apagar pantalla' : 'Encender pantalla'}
            >
              {screen.active ? <Pause className="w-5 h-5" /> : <Play className="w-5 h-5" />}
            </button>
          </div>
        </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex items-center">
                <div className={`w-3 h-3 rounded-full mr-2 ${
                  screen.active ? 'bg-green-500' : 'bg-red-500'
                }`}></div>
                <span className={screen.active ? 'text-green-700' : 'text-red-700'}>
